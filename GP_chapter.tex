...
\caption{Rotation periods measured using the ACF method as a function of the
...
\caption{Rotation periods measured using the LS periodogram method as a
...
\caption{Measured vs true rotation period for \nlightcurves\ simulated light
