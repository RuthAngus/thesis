...
determined accurately to within 20\% \cite{Soderblom2010}.
...
angular momentum loss, is related to rotation period \cite{Kawaler1988}.
...
for solar mass stars: 650 Myrs \cite{Radick1987, Irwin2009}.
After this time, rotation periods are thought to be \emph{independent} of their
initial values.  % referee
...
a different dynamo-driven magnetic field \cite{Kraft1967}.
...
$\alpha$ Per \cite{Prosser1995}, Pleiades \cite{Prosser1995,
Krishnamurthi1998}, M34 \cite{Meibom2011_M34}, and Hyades \cite[Henry,
...
\cite{Casagrande2010, SilvaAguirre2012} and the other from a recalibration of
the SDSS griz filter KIC photometry by \citet{Pinsonneault2012} using Yale
Rotating Stellar Evolution Code (YREC) models \cite{Demarque2004}.
...
simply an average value for the field: $-0.2\pm0.3$ dex \cite[see e.g.][]{Silva_Aguirre2011}.  % referee
...
uncertainties as small as 10\% \cite{Brown1994, SilvaAguirre2013}.
...
\sim$ 6250 K, \cite{Kraft1967} do not have a thick convective envelope and
...
leaving the classically defined MS \cite{vanSaders2013}.
...
fitter \cite[][used a flat prior PDF in age and \logg]{Chaplin2014}.
...
We used {\tt emcee} \cite{Foreman-Mackey2013}, an affine invariant, ensemble
...
detection, sometimes known as Malmquist bias \cite{Malmquist1920}.
