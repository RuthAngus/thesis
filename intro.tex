...
populations would be a mystery.
Our understanding of the formation history of the Milky way would be limited
and with it, the formation process of all galaxies.

The application for stellar ages that most piques my personal interest is the
...
Three types of oscillations manifest themselves in stars: pressure, or p-modes,
...
\citet{Kawaler1988} developed the first physical model of a star undergoing
magnetic braking.
...
to enormous velocities and huge numbers of particles and energy are released
...
the bulge, the thin disc, the thick disc and the halo.
...
Before that however, in chapter \ref{chapter:gyro} I present the results of my
work on gyrochronology.
...
After that, in chapter \ref{chapter:flicker} I present my work on the
probabilistic calibration of the relation between short-term stellar
brightness variability (known as flicker) and stellar density and surface
gravity.
